...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#080612] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      {/* Background glows */}
      <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-violet-800 rounded-full opacity-20 blur-[120px] pointer-events-none" />
      <div className="absolute -bottom-32 -left-32 w-[420px] h-[420px] bg-purple-700 rounded-full opacity-20 blur-[100px] pointer-events-none" />
      <div className="absolute top-1/3 left-1/3 w-[260px] h-[260px] bg-purple-900 rounded-full opacity-10 blur-[80px] pointer-events-none" />

      {/* Card */}
      <div className="relative w-full max-w-md">

        {/* Top accent line */}
        <div className="h-px w-full bg-gradient-to-r from-transparent via-violet-500 to-transparent mb-8" />
        ...
        <div className="bg-[#100d1f]/80 backdrop-blur-xl border border-purple-900/40 rounded-2xl p-8 shadow-[0_0_60px_rgba(109,40,217,0.15)]">
          ...
          <div className="mb-8 text-center">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-600 to-purple-900 shadow-[0_0_24px_rgba(139,92,246,0.5)] mb-5">
              <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
              </svg>
            </div>
            <h1 className="text-3xl font-bold text-white tracking-tight">Welcome Back</h1>
            <p className="text-purple-300/60 text-sm mt-2 font-light">Sign in to continue to your account</p>
          </div>
          ...
          <div className="space-y-5">
            {fields.map(({ name, label, type, placeholder, icon }) => (
              <div key={name}>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-xs font-semibold text-purple-300/80 uppercase tracking-widest">
                    {label}
                  </label>
            ...
            <button
              onClick={handleClick}
              type="button"
              className="group relative w-full mt-1 py-3.5 rounded-xl font-semibold text-sm text-white overflow-hidden bg-gradient-to-r from-violet-700 to-purple-600 hover:from-violet-600 hover:to-purple-500 transition-all duration-200 shadow-[0_4px_24px_rgba(109,40,217,0.4)] hover:shadow-[0_4px_32px_rgba(139,92,246,0.55)] active:scale-[0.98]"
            >
          ...
          <p className="text-center text-purple-400/50 text-sm mt-6">
            ...
            <Link to='/signup' className="text-purple-400 hover:text-purple-300 font-medium transition-colors duration-150 underline underline-offset-2 decoration-purple-600/50 hover:decoration-purple-400">
              Sign up
            </Link>
          </p>
        </div>
